...
import { render, cleanup, waitForElement, fireEvent, getAllByTestId, getByPlaceholderText, getByAltText, getByTestId, waitForElementToBeRemoved, queryByText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("cancels an interview and increases spots remaining by 1", async () => {
    ...
    // 7. Wait until the element with the "DELETING..." text is removed.
